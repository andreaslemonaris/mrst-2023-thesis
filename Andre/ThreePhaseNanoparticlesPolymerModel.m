classdef ThreePhaseNanoparticlesPolymerModel < ThreePhaseBlackOilModel
    ...
    %
    % SYNOPSIS:
    %   model = ThreePhaseNanoparticlesPolymerModel(G, rock, fluid, varargin)
    %
    % DESCRIPTION:
    %   Fully implicit three phase blackoil model with polymer and/or nanoparticles.
    %
    % PARAMETERS:
    %   G        - Grid
    %   rock     - Rock structure
    ...
    methods
        ...
        function state = validateState(model, state)
            ...
            if model.surfactant
                ...
                fn2 = model.getVariableField('SurfactantMax');
