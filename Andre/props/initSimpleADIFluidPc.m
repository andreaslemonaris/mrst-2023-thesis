function fluid = initSimpleADIFluidPc(varargin)
...
% viscosities, capillary pressure). Relative permeabilities are modeled as monomial functions
...
%
% SYNOPSIS:
%   fluid = initSimpleADIFluidPc()
%   fluid = initSimpleADIFluidPc('pn1', 'pv1')
%
% OPTIONAL PARAMETERS:
...
%             * pcOW, pcWG, pcOG - Capillary pressure functions
%             * pcX(s)           - Capillary pressure for X
%
% EXAMPLE: 
...
%   fluid = initSimpleADIFluidPc('phases', 'WOG', ...
...
%
%   fluid = initSimpleADIFluidPc('phases', 'OW', ...
%                              'mu',      [8, 1]*centi*poise, ...
