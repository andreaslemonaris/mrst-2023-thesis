function [problem, state] = equationsThreePhaseNanoparticlesPolymer(state0, state, model, ...
    dt, drivingForces, varargin)
    %
    % SYNOPSIS:
    %   function [problem, state] = equationsThreePhaseNanoparticlesPolymer(state0, state, model, dt, drivingForces, varargin)
    %
    % DESCRIPTION:
    %   Assemble the linearized equations for a blackoil nanoparticle-polymer system,
    ...
    %
    %   A description of the modeling equations can be found upon request
    %   
    %
    %
    % PARAMETERS:
