classdef OilWaterNanoModel < ThreePhaseNanoPolymerModel
    %
    %
    % SYNOPSIS:
    ...
    methods
        ...
        function model = OilWaterNanoModel(G, rock, fluid, varargin)

            model = model@ThreePhaseNanoPolymerModel(G, rock, fluid);
            model.nanoparticles = true;
            model.gas = false;
            model.water = true;
            model.oil = true;
            model.disgas = false;
        ...
        function [problem, state] = getEquations(model, state0, state, dt, drivingForces, varargin)
            [problem, state] = equationsOilWaterNano(state0, state, ...
                                                           model, dt, ...
                                                           drivingForces, ...
                                                           varargin{:});
        end
