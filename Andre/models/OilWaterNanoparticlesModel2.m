classdef OilWaterNanoparticlesModel2 < ThreePhaseNanoparticlesPolymerModel2
    %
    %
    % SYNOPSIS:
    ...
    methods
        ...
        function model = OilWaterNanoparticlesModel2(G, rock, fluid, varargin)

            model = model@ThreePhaseNanoparticlesPolymerModel2(G, rock, fluid);
